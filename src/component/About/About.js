    ...
    return (
        <div className='grid lg:grid-cols-2 gap-2 mt-2'>
            ...
            <div className='ml-8 mt-8'>
                ...
                <p className='text-blue text-base lg:text-lg mt-8 ml-4 mr-12'>Chúng mình là một nhóm cán bộ, giảng viên, và sinh viên đại học tại Đại học Fulbright Việt Nam. Chúng mình thiết kế MindFulbright với mong muốn đem đến cho bạn một không gian để nghỉ ngơi, thông qua việc thực hành Chánh niệm. </p>
