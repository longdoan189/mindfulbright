        ...
        <div>
            <div className='grid sm:grid-cols-2'>
                <div className='ml-2 sm:ml-24 lg:ml-40 lg:mt-20'>
                    <h1 className='text-blue text-center sm:text-left text-3xl lg:text-5xl font-bold'>An&nbsp;trú trong hiện&nbsp;tại</h1>
                    ...
                    <button className="text-sm md:text-lg mt-5 background-gold hover:text-yellow-500 px-3 py-3 border rounded-lg mx-auto block" onClick={() => {setOpenModal(true)}}><b>Chọn bài tập phù hợp</b></button>
                </div>
