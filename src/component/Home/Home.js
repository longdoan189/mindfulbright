        ...
        <div>
            <div className='grid sm:grid-cols-2'>
                <div className='ml-2 sm:ml-24 lg:ml-40 lg:mt-20'>
                    <h1 className='text-blue text-left text-3xl lg:text-5xl font-bold'>Stay Healthy & <br/> Be Present</h1>
                    <p className='mt-8 text-black text-left text-lg font-bold'>MindFulbright là một không gian để chữa lành và thư giãn, thông qua việc thực hành Chánh niệm. Với những video và podcast hướng dẫn, bé Chani sẽ cùng bạn lần lượt đi qua các bài tập giúp cải thiện sức khoẻ tinh thần của bạn. </p>
                ...
                <div className='ml-2 sm:ml-16 lg:ml-32 mr-12 mt-12'>
