...
export default function Selected(props) {
    ...
    return (
        <div className={"fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto " + (isOpen ? "" : "hidden")}>
            <div className="relative my-auto mx-auto p-5 border sm:w-2/3 h-screen shadow-lg rounded-md bg-white z-10">
                <div className='text-xl sm:text-2xl lg:text-5xl text-right mr-4'>
                    <div className='inline-block'>
                        <span className='text-gold'>Hôm nay</span>
                        <span className='text-blue'>, bạn có thể thử</span>
                    </div>
                    <div className="modal-close cursor-pointer inline-block lg:ml-20 mr-4" onClick={() => {toggleOpen(false); dispatch({type: "RESET_SELECTION"})}}>
